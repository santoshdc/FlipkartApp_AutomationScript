...
public class OsPath {
	...
	public static String getPath(String browser) 
	{
		...
		if(OS.toUpperCase().contains("WINDOWS"))
		{
			...
			{
				driverPath=".\\src\\main\\java\\com\\flipkart\\resources\\Chrome\\chromedriver.exe";
				
				
			}
			else if(browser.toUpperCase().contains("FF")||browser.toUpperCase().contains("FIRE"))
			{
				driverPath=".\\src\\main\\java\\com\\flipkart\\resources\\geckodriver.exe";
		...
		else if(OS.toUpperCase().contains("MAC"))
		{
			...
			if(browser.toUpperCase().contains("CHROME"))
			{
				driverPath=".\\src\\main\\java\\com\\flipkart\\resources\\chromedriver.exe";
			}
			else if(browser.toUpperCase().contains("FF")||browser.toUpperCase().contains("FIRE"))
			{
				driverPath=".\\src\\main\\java\\com\\flipkart\\resources\\geckodriver.exe";
