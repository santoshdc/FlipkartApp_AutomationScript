...
import com.flipkart.listeners.WebEventListener;
import com.flipkart.report.ExtentReporterNG;
...
public class Driver  {
	...
	public Driver(){
		try {
			...
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "\\src\\main\\java\\com\\flipkart\\resources\\properties.properties");
			prop.load(ip);
